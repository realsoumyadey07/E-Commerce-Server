...
productRouter.post("/create-product", auth_middleware_1.isAuthenticated, (0, auth_middleware_1.authorizeRoles)("admin"), multer_middleware_1.upload.array("images", 4), product_controller_1.createProduct);
