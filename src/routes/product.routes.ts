...
import { createProduct, deleteProduct, getAllCategoryProducts, getAllProducts, getProductById, searchProduct, updateProduct, userSearchProduct } from "../controller/product.controller";
...
productRouter.get("/get-category-products", getAllCategoryProducts);
